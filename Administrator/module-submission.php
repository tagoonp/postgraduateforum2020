              ...
              <div class="section-body mt-2">
                <div class="row d-none d-sm-block">
                  <div class="col-12">
                      ...
                      <button type="button" class="btn btn-success text-dark- bsdn" onclick="window.location='./module-submission?uid=<?php echo $uid;?>'"><i class="fas fa-bar"></i> All submission</button>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <table class="table table-striped mb-0" id="table-1">
                          ...
                          <tbody>
                            <?php
                            $strSQL = "SELECT * FROM udix2_submission WHERE sub_use_status = 'Y' AND sub_submit_status NOT IN ('Draft')";
                              ...
                              while($row = mysqli_fetch_array($resultAbstract)){
                                ...
                                <tr>
                                  ...
                                  <td class="pt-2 pb-2" style="vertical-align: top;">
                                    ...
                                    <div class="">
                                      <?php
                                      $strSQL = "SELECT author_fullname, author_presenter FROM udix2_author WHERE author_pid = '".$row['PID']."'";
                                  ...
                                  <td style="width: 150px;">
                                    <div class="">
                                      ...
                                      if($row['sub_submit_status'] == 'Withdraw'){
                                        ?>
                                        <button type="button" class="btn btn-icon text-secondary" disabled><i class="fas fa-pencil-alt"></i></button>
                                        <button type="button" class="btn btn-icon text-secondary" disabled><i class="fas fa-trash"></i></button>
                                        <?php
                                      }else{
                                        if($row['sub_draft'] == 'Y'){
                                          ?>
                                          ...
                                          ?>
                                          <button type="button" class="btn btn-icon" onclick="" disabled><i class="fas fa-pencil-alt"></i></button>
                                          <?php
                                        }
                                      }
                                      ?>
                                      ...
                                      if($row['sub_submit_status'] != 'Withdraw'){
                                        ?>
                                        <button type="button" class="btn btn-icon text-danger" onclick="WithdrawSubmittion('<?php echo $row['PID'];?>', '<?php echo $row['sub_title']; ?>')"><i class="fas fa-trash"></i></button>
                                        <?php
                                      }
                                      ?>
