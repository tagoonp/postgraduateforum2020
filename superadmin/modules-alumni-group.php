                    ...
                    <table class="table">
                      <thead>
                        <tr class="bg-secondary">
                          ...
                          <th class="text-dark" scope="col">Group name</th>
                          <th class="text-dark" scope="col" style="width: 100px !important;">Domain</th>
                          <th class="text-dark" scope="col"></th>
                        </tr>
                      </thead>
                      <tbody id="result1">
                        <?php
                        $tb1 = $db_prefix."alumnigroup";
                        $tb2 = $db_prefix."subdomain";
                        $strSQL = "SELECT * FROM $tb1 a LEFT JOIN $tb2 b ON a.pg_domain = b.ID WHERE 1";
                        // echo $strSQL;
                        ...
                        if(($query) && (mysqli_num_rows($query) > 0)){
                          ...
                          while($row = mysqli_fetch_array($query)){
                            ...
                            <tr>
                              ...
                              <td>
                                <?php echo $row['pg_name_th']." (".$row['pg_name_en'].")"; ?>
                                <div class="fs08 fx08">
                                  URL : <a href="<?php echo $row['pg_url'];?>" target="_blank"><?php echo $row['pg_url'];?></a>
                                </div>
                              </td>
                              <td style="width: 100px;"><?php echo $row['sub_domain']; ?></td>
                              <td class="text-right">
                            ...
                            echo '<tr><td colspan="4" scope="row" class="text-center">No group found</td></tr>';
                        }
                        ?>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title text-white pb-3" id="exampleModalLabel">Create new personal group</h5>
      ...
      <form class="new-pagegroup-form" onsubmit="return false;">
        <div class="modal-body">
            <div class="form-group">
              <label for="">Group name [TH]<span class="text-danger">*</span> </label>
              <input type="text" name="txtNameTh" id="txtNameTh" class="form-control">
            </div>

            <div class="form-group">
              <label for="">Group name [EN]<span class="text-danger">*</span> </label>
              <input type="text" name="txtNameEn" id="txtNameEn" class="form-control">
            </div>
        </div>
