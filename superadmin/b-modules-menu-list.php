...
<body>
                ...
                <div class="card">
                  <div class="card-footer">
                    <div class="row">
                      ...
                      <div class="col-3">
                        ...
                        <input type="text" name="txtSearch" id="txtSearch" value="<?php echo $searchterm;?>" class="form-control" placeholder="Enter menu name ...">
                      </div>
                      <div class="col-6 text-right">
                        <nav class="d-inline-block">
                          <ul class="pagination mb-0">
                            <?php
                            $tb1 = $db_prefix."menus";
                            $strSQL = "SELECT COUNT(*) qmenu FROM $tb1 WHERE domain_id = 'null'";
                  ...
                  <div class="card-body p-0">
                    <table class="table mb-0">
                      ...
                      <tbody id="result1">
                        <tr><td colspan="6" scope="row" class="text-center">No items found</td></tr>
                      </tbody>
                    </table>
                  </div>
                </div>
  ...
  <script type="text/javascript" src="../assets/core/page/js/admin.js"></script>
