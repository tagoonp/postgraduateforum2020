      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12">
                <h6>Menu position list</h6>
                <div class="card">
                  <div class="card-footer">
                    <div class="row">
                      <div class="col-3"><button class="btn btn-primary"><i class="fas fa-plus"></i> Add new position</button></div>
                    ...
                    <table class="table mb-0">
                      <thead>
                        <tr class="bg-secondary">
                          ...
                          <th class="text-dark" scope="col">First</th>
                          <th class="text-dark" scope="col">Position info.</th>
                      ...
                      <tbody id="result1">
                        ...
                        if($query){
                          while($row = mysqli_fetch_array($query)){
                            ?>
                            <tr>
                              <td class="tb-style-1"><?php echo $row['pos_id']; ?></td>
                              <td class="tb-style-1"><?php echo $row['position_title']; ?></td>
                              <td class="tb-style-1"><?php echo $row['position_detail']; ?></td>
                              <td class="tb-style-1">
                                <label class="custom-switch mt-2 pl-0">
                                  <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input" <?php if($row['position_status'] == '1'){ echo "checked"; }; ?>>
