      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12">
                <h6>Sub-domain list</h6>
                <div class="card">
                  <div class="card-footer">
                    <div class="row">
                      <div class="col-3"><button class="btn btn-primary" onclick="window.location = 'modules-subdomain-add?uid=<?php echo $uid;?>'"><i class="fas fa-plus"></i> Add new sub-domain</button></div>
                    ...
                    <table class="table mb-0">
                      <thead>
                        <tr class="bg-secondary">
                          ...
                          <th class="text-dark" scope="col">Sub-domain</th>
                      ...
                      <tbody id="result1">
                        ...
                        if($query){
                          while($row = mysqli_fetch_array($query)){
                            ?>
                            <tr>
                              <td style="vertical-align: top; padding-top: 5px; padding-bottom: 5px;"><?php echo $row['ID']; ?></td>
                              <td style="vertical-align: top; padding-top: 5px; padding-bottom: 5px;">
                                <?php echo $row['sub_domain']; ?>
                                <div class="" style="font-size: 0.9em;">
                                  URL : <a href="<?php echo $row['sub_domain_url']; ?>" target="_blank"><?php echo $row['sub_domain_url']; ?></a>
                                </div>
                                <div class="" style="font-size: 0.9em;">
                                  Detail : <?php echo $row['sub_description']; ?>
                                </div>
                              </td>
                              <td style="vertical-align: top; padding-top: 5px; padding-bottom: 5px;">
                                <label class="custom-switch mt-2 pl-0">
                                  <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input" <?php if($row['sub_domain_status'] == '1'){ echo "checked"; }; ?>>
                                  <span class="custom-switch-indicator"></span>
                                </label>
                              </td>
                              <td style="vertical-align: top; padding-top: 5px; padding-bottom: 5px;" class="text-right">
                            ...
                            echo '<tr><td colspan="5" scope="row" class="text-center">No position found</td></tr>';
                        }
                        ?>
