              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-footer">
                    <div class="row">
                      <div class="col-3"><button class="btn btn-primary btn-block" onclick="window.location = 'modules-page-new?uid=<?php echo $muid;?>'"><i class="fas fa-plus"></i> Add new page</button></div>
                      <div class="col-3">
                        <input type="hidden" name="" id="txtStartNum" value="<?php echo $first_row + 1;?>" class="hidden">
                        <input type="text" name="txtSearch" id="txtSearch" value="<?php echo $searchterm;?>" class="form-control" placeholder="Enter page name ...">
                      </div>
                      <div class="col-6 text-right">
                        <nav class="d-inline-block">
                          <ul class="pagination mb-0">
                            ...
                            $strSQL = "SELECT COUNT(*) qmenu FROM $tb1 WHERE post_domain = 'null' AND post_type = 'page'";
                              ...
                              for ($i=1; $i <= $num_btn; $i++) {
                                if($i == 1){
                                  ...
                                  <li class="page-item <?php if($cpage == 1){ echo "disabled"; } ?>">
                                    <a class="page-link" href="Javascript:gotoLocalPage('modules-page-list?uid=<?php echo $uid;?>&page=<?php echo $prevpage;?>')" tabindex="-1"><i class="fas fa-chevron-left"></i></a>
                                  </li>
                                  <?php
                                }
                                ...
                                echo '<li class="page-item '.$mnactive.'"><a class="page-link" href="Javascript:gotoLocalPage(\'modules-page-list?uid='.$uid.'&page='.$i.'\')">'.$i.' <span class="sr-only">(current)</span></a></li>';

                                if($i == $num_btn){
                                  ?>
                                  <li class="page-item <?php if($i == $cpage){ echo "disabled"; } ?>">
                                    <a class="page-link" href="Javascript:gotoLocalPage('modules-page-list?uid=<?php echo $uid;?>&page=<?php echo $nextpage;?>')"><i class="fas fa-chevron-right"></i></a>
                                  </li>
                                  <?php
                                }
                              }
                  ...
                  <div class="card-body p-0">
                    <table class="table mb-0">
                      ...
                      <tbody id="result1">
                        <tr><td colspan="6" scope="row" class="text-center">No page found</td></tr>
                      </tbody>
                    </table>
                  </div>
                </div>
