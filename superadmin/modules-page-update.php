                  ...
                  <div class="card-body">
                    <form class="new-page-form" onsubmit="return false;">
                      <div class="form-group">
                        ...
                        <input type="text" name="txtTitle" id="txtTitle" value="" class="form-control" placeholder="Enter page title ...">
                      </div>

                      <div class="form-group dn">
                        <label for="">URL <span class="text-danger">*</span></label>
                        <input type="text" name="txtUrl" id="txtUrl" value="" class="form-control" placeholder="Enter page url ...">
                      </div>
                      ...
                      <div class="row">
                          ...
                          <select class="form-control" name="txtCategory" id="txtCategory">
                            ...
                            if($query){
                              while($row = mysqli_fetch_array($query)){
                                ?>
                                <option value="<?php echo $row['cat_id']; ?>"><?php echo " [".$row['lang_short_name']."] ".$row['cat_name']; ?></option>
                                <?php
                              }
                            }
                            ?>
                        ...
                        <div class="form-group col-12 col-sm-6">
                          <label for="">Alt </label>
                          <input type="text" name="txtAlt" id="txtAlt" value="" class="form-control" placeholder="Enter short detail ...">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="">Content</label>
                        <textarea class="summernote" id="txtContent"></textarea>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-12 col-sm-6">
                          <label>Tags</label>
                          <input type="text" class="form-control inputtags" id="txtTags">
                        </div>
                      </div>

                      <div class="form-group">
                        <label>Figure URL </label><a href="#" onclick="" class="float-right"><i class="fas fa-image mr-2"></i></i>Choose from album</a>
                        <input type="text" class="form-control inputtags" id="txtFigure">
