...
$tb1 = TB_PREFIX.'personal';
$tb2 = TB_PREFIX."persongroup";
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-footer">
                    <div class="row">
                      <div class="col-3"><button class="btn btn-primary btn-block" onclick="showModal('add_person_modal')"><i class="fas fa-plus"></i> Add new person</button></div>
                      <div class="col-3">
                      ...
                      <tbody>
                        ...
                        if(($query) && (mysqli_num_rows($query) > 0)){
                          ...
                          while($row = mysqli_fetch_array($query)){
                            ...
                            $menu_btn = '<button class="btn btn-primary mr-1 bsdn btn-icon" onclick="admin.menu_edit(\''.$row['PID'].'\')"><i class="fas fa-pencil-alt"></i></button>'.
                                        '<button class="btn btn-primary mr-1 bsdn btn-icon" onclick="admin.menu_delete(\''.$row['PID'].'\')"><i class="fas fa-trash"></i></button>';
