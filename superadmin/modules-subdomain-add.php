...
<body>
          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12">
                <div class="row">
                  <div class="col-12">
                    <button class="btn btn-primary" onclick="window.location = 'modules-subdomain-list'"><i class="fas fa-bars"></i> Sub-domain list</button>
                  </div>
                </div>
                <div class="card mt-2">
                  <div class="card-body">
                    <form class="new-doamin-form" onsubmit="return false;">
                      <div class="form-group">
                        <label for="">Sub-domian name <span class="text-danger">*</span></label>
                        <input id="txtName" type="text" name="" value="" class="form-control" placeholder="Enter sub-domain name ..." autofocus>
                      </div>
                      <div class="form-group">
                        <label for="">Sub-domian description </label>
                        <textarea id="txtDesc" name="name" rows="8" cols="80" class="form-control" style="height: 200px !important;"></textarea>
                      </div>
  ...
  <script type="text/javascript">
    ...
    $(function(){
      $('.new-doamin-form').submit(function(){
        $check = 0
